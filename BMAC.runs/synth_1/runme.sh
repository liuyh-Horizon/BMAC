...
HD_PWD='/home/yuhaoliu/Projects/Verilog/BMAC/BMAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BMAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BMAC.tcl
